...
#ifdef ALLOC_PRAGMA
#pragma alloc_text (PAGE, USBDriver1QueueInitialize)
#endif

NTSTATUS
USBDriver1QueueInitialize(
...
--*/
{
    ...
    queueConfig.EvtIoDeviceControl = USBDriver1EvtIoDeviceControl;
    queueConfig.EvtIoStop = USBDriver1EvtIoStop;
